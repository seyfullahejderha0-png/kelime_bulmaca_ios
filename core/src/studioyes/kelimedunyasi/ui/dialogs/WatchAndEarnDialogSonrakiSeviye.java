...
public class WatchAndEarnDialogSonrakiSeviye extends BaseDialog{
    ...
    public WatchAndEarnDialogSonrakiSeviye(float width, float height, BaseScreen screen, Runnable callback) {
        ...
        Label adInvite = new Label(LanguageManager.get("ad_invite_sonrakiseviye"), bodyTextStyle);
        ...
        coins = new Image(AtlasRegions.next_coins);
